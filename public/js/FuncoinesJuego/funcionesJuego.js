...
window.onload = function () {
	Swal.fire({
		title: 'Desea continuar con un pequño tutorial?',
		...
		if (result.isConfirmed) {
			Swal.fire({
				title: 'Mover nave',
				text: "Para mover la nave a la derecha precione la tecla -> de su teclado",
				...
				Swal.fire({
					title: 'Mover nave',
					text: `Para mover la nave a la Izquierda precione la tecla <- de su teclado`,
					showCancelButton: false,
					confirmButtonColor: '#3085d6',
					confirmButtonText: 'Continuar'
				}).then((result) => {
					Swal.fire({
						title: 'Disparar',
						text: "Para disparar precione la tecla espacio de su teclado",
						showCancelButton: false,
						confirmButtonColor: '#3085d6',
						confirmButtonText: 'Continuar'
					}).then((result) => {
						Swal.fire({
							title: 'Instrucciones',
							text: "Destruya las naeevs enemigas y esquibe los disparos, Si es colicionado por algun misil del enemigo morira",
							showCancelButton: false,
							confirmButtonColor: '#3085d6',
							confirmButtonText: 'Continuar'
						}).then((result) => {
